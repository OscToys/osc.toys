...
> Using mac or linux? OGB hasn't been tested on them, but you can probably clone the repo, make sure pnpm is installed, then `pnpm install && pnpm run build && pnpm start`
